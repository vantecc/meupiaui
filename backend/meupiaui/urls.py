...
from .views import CityViewSet, TouristPointViewSet, FavoriteViewSet, CategoryViewSet,ProfileViewSet, register_view, CustomObtainAuthToken, ExistProfileView, SearchPoint, HasFavorite
